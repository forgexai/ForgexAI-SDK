...
async function crossmintExample() {
  try {
    ...
    try {
      ...
      console.log('Wallet creation failed (expected with demo data):', error.message);
    }
    ...
    try {
      ...
      console.log('Wallet retrieval failed (expected with demo data):', error.message);
    }
    ...
    try {
      ...
      console.log('Balance check failed (expected with demo data):', error.message);
    }
    ...
    try {
      ...
      console.log('NFT listing failed (expected with demo data):', error.message);
    }
    ...
    console.log('   1. Get a real Crossmint API key from https://crossmint.com');
